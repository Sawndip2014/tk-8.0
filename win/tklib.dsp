...
"lib_$(InputName).c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	\src\tcl-8.0\win\tcl2c\Release\tcl2c.exe lib_$(InputName) < $(InputPath) > lib_$(InputName).c
